...
const skills: Skill[] = [
  ...
  },
  {
    ...
    description: `Pengeditan video mencakup pengolahan video dan foto untuk menciptakan konten yang menarik dan relevan. Ini melibatkan berbagai software dan teknik untuk menyunting dan memodifikasi video agar sesuai dengan kebutuhan dan preferensi audiens.`,
  },
];
